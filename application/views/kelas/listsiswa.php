								...
								<tbody>
									...
									?>
										<tr>
											...
											<?php if ($this->session->userdata('level') == 'admin') { ?>
												<td>
													<a class="btn btn-danger" href="<?= base_url('DataKelas/hapusHistoriKelasSiswa/' . $row->id_histori . '/' . $row->kode_kelas) ?>" onclick="return confirm('yakin ?')">Hapus</a>
												</td>
											<?php } ?>
										</tr>
									<?php
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="FormlistSiswa" action="<?= base_url('DataKelas/InsertKelasSiswa/' . $kelas['kode_kelas']) ?>" method="post">
			...
			<div class="modal-footer">
				...
				<input type="submit" id="btnSaveSiswa" form="FormlistSiswa" class="btn btn-primary" disabled value="Simpan" />
			</div>
		</div>
	</div>
</div>
