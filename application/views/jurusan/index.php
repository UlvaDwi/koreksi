                  ...
                  <form action="<?= base_url() ?>DataJurusan/validation_form" method="post" accept-charset="utf-8">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="kode_jurusan">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Nama Jurusan</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="nama_jurusan">
                      </div>
