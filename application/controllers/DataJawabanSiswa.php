 ...
 * 
 */
class DataJawabanSiswa extends CI_Controller
{
	...
	function index()
	{
		...
		$data['jawabansiswa'] = $this->JawabanSiswa_Model->getAllData();

		$this->load->view('templates/header');
		$this->load->view('templates/sidebar');
		$this->load->view('jawabansiswa/index', $data);
		$this->load->view('templates/footer');
	}
	function indexpre()
	{

		$data['prejawaban'] = $this->PreJawabanSiswa_Model->getAllData();
		$this->load->view('templates/header');
		$this->load->view('templates/sidebar');
		$this->load->view('prejawaban/index', $data);
		$this->load->view('templates/footer');
	}
	...
	public function hapus($kd)
	{
		...
		$this->JawabanSiswa_Model->hapus_data($kd);
		$this->session->set_flashdata('flash_jawabansiswa', 'Dihapus');
	...
	public function ubah($kd)
	{
		...
		$this->form_validation->set_rules("id_jawaban_siswa", "id jawaban siswa", "required");
		...
		if ($this->form_validation->run() == FALSE) {
			$data['ubah'] = $this->JawabanSiswa_Model->detail_data($kd);
			$this->load->view('templates/header');
			$this->load->view('templates/sidebar');
			$this->load->view('jawabansiswa/ubah', $data);
			$this->load->view('templates/footer');
		} else {
			$this->JawabanSiswa_Model->ubah_data();
			$this->session->set_flashdata('flash_jawabansiswa', 'DiUbah');
			redirect('DataJawabanSiswa');
		}
	}
	/*------------TOKENIZING------------*/
